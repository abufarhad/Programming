...
int main()
{
    ...
    tcas(cs, t)
    {
        ...
        if(n>=4)
        {
            if(s[0]=='2'  and s[n-1]=='0'  and s[n-2]=='2' and s[n-3]==s[n-1])cnt=1;
            else if( s[0]=='2'  and s[1]=='0'  and s[n-2]=='2' and s[1]==s[n-1] )cnt=1;
            else if( s[0]=='2'  and s[1]=='0'  and s[n-2]=='2' and s[1]==s[n-1] )cnt=1;
            else if( s[0]=='2'  and s[1]=='0'  and s[2]=='2' and s[n-1]=='0' )cnt=1;

            else if( s[0]=='2'  and s[1]=='0'  and s[2]=='2' and s[3]=='0' )cnt=1;
            else if( s[n-4]=='2'  and s[n-3]=='0'  and s[n-2]=='2' and s[n-1]=='0' )cnt=1;
        }
