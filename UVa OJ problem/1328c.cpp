...
int main()
{
    ...
    tcas(cs, t)
    {
        ...
        fr(i,n)
        {
                if(s[i]=='2' and chk==1) s1+='0', s2+='2';
                else if(s[i]=='2' and chk==0)  s1+='1', s2+='1';

                if(s[i]=='1' and chk==0) s1+='1', s2+='0' , chk=1;
                else if(s[i]=='1' and chk==1)  s1+='0', s2+='1';


                else if( s[i]=='0')  s1+='0', s2+='0' ;
